...
number_albums
```
#Sadie- how come you filtered those albums above?  Also, maybe make the output more visible than just the readout from running it?- maris
...
```
### Most Used Lyrics
#Sadie- do you mean like used by other people (covers) or used in general?  Maybe outline when you do this section?
## Where Did They Tour?
...
map_tour
```
#Sadie- maybe add a legend to tell what the circle marker colors mean using addLegend()- you can check out directions here: https://rstudio.github.io/leaflet/legends.html
